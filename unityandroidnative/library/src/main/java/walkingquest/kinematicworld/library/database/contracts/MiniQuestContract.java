...
public final class MiniQuestContract {

    public MiniQuestContract(){}

    public static class MiniQuest implements BaseColumns{
    ...
    // todo remove these and add a new class that will serve as the interface for the MiniQuest
    public static class MiniQuestCommands{
